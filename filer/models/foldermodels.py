...
from ..utils.compatibility import python_2_unicode_compatible, callable_bool
...
class Folder(models.Model, mixins.IconsMixin):
    ...
    def has_generic_permission(self, request, permission_type):
        ...
        """
        user = request.user
        if not callable_bool(user.is_authenticated):
            return False
...
class FolderPermission(models.Model):
    ...
    group = models.ForeignKey(auth_models.Group,
                              ...
                              verbose_name=_("group"), blank=True, null=True, on_delete=models.CASCADE)
